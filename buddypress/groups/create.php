			...
			<div class="item-body" id="group-create-body">
				...
				<?php if ( 'crop-image' != bp_get_avatar_admin_step() ) : ?>
					...
					<div class="submit" id="previous-next">
						...
						<?php endif; ?>
						<?php if ( bp_is_group_creation_step( 'group-settings' ) ) :
							$group = groups_get_group( array( 'group_id' => bp_get_new_group_id() ) );
							$group_permalink = trailingslashit ( bp_get_root_domain() . '/' . bp_get_groups_root_slug() . '/' . $group->slug . '/' );
							?>
							<input type="button" value="<?php esc_attr_e( 'Gruppe erstellen und später konfigurieren', 'boss' ); ?>" id="group-creation-finish" onclick="location.href='<?php echo $group_permalink; ?>'" />
