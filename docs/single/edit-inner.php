	...
	<form action="" method="post" class="standard-form" id="doc-form">
	    ...
	    <div class="doc-content-wrapper">
			...
			<div id="doc-submit-options" style="float: right; display:flex; width:150px; margin-top: 0px; height:50px">

				<?php wp_nonce_field( 'bp_docs_save' ) ?>

				<input type="hidden" id="doc_id" name="doc_id" value="<?php echo $doc_id ?>" />
				<input type="submit" name="doc-edit-submit" id="doc-edit-submit" value="<?php _e( 'Save', 'buddypress-docs' ) ?>">

			</div>

			<div id="doc-content-title" style="display: flex">
		...
		<div style="clear: both"> </div>
			...
			<?php if ( bp_docs_is_existing_doc() ) : ?>
				...
				<?php endif ?>
			<?php endif ?>
			<!--<a href="<?php bp_docs_cancel_edit_link() ?>" class="action safe"><?php _e( 'Cancel', 'buddypress-docs' ); ?></a>-->
